...
- [File:](05.Control-Details/File.md) Save files directly in a DataPortal.
...
- [Percent:](05.Control-Details/Percent.md) Enter a number as a percentage.
...
- [SSNMasked:](05.Control-Details/SSNMasked.md) Enter a Social Security Number, securely hiding the first 5 digits.
