...
The **ReadOnlyCondition** column on a container field determines whether the field should be read only. If set to `True`, the input field is grayed out and only data prepopulated in forms will be displayed.

## Controls

The **ReadOnlyCondition** column applies to the following controls:
