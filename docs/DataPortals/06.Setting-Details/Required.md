...
The **Required** column on a container field defines whether a value must be provided to save the page. If set to `True` (case-insensitive), the given field is required.

## Controls

The **Required** column applies to the following controls:
