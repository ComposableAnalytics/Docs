...
The **ControlType** column on a container field defines what kind of control to create.

## Controls

The **ControlType** column applies to all controls. It's possible values are:
...
- [File](../05.Control-Details/File.md)
...
- [SSNMasked](../05.Control-Details/SSNMasked.md)
