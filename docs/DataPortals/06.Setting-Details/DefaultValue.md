...
The **DefaultValue** column on a container field defines the default value for each control. For [AppRun,](../05.Control-Details/AppRun.md) [QueryView,](../05.Control-Details/QueryView.md) and [QueryViewChooser](../05.Control-Details/QueryViewChooser.md) controls this must be the ID of the Composable resource to be used.

## Controls

The **DefaultValue** column applies to the following controls:
