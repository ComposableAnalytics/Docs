...
The **UniqueConstraint** column on a container field allows for the generation of a database index to enforce uniqueness on one or more container fields.
...
The **UniqueConstraint** column applies to the following controls:
