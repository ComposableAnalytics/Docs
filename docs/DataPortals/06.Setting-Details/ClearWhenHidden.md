...
The **ClearWhenHidden** column on a container field defines whether a field's value should be cleared (set to `null`) when the control is hidden.

## Controls

The **ClearWhenHidden** column applies to the following controls:
