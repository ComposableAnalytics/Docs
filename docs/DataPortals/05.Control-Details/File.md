...
- [**Type**](../06.Setting-Details/Type.md): Must be set to `System.Byte`.

- [**ControlType**](../06.Setting-Details/ControlType.md): Must be set to `File`.

## Optional Fields

- [**MaxSizeInMB**](../06.Setting-Details/MaxSizeInMB.md): The maximum size of the file in megabytes.

- [**AllowedFileTypes**](../06.Setting-Details/AllowedFileTypes.md): A comma-separated list of allowed file extensions.
