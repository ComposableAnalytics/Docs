...
In the View mode, clicking the `Export` button will export the full results of your query (not just the current page) as a csv or xlsx file. Under `Options` you can switch between the file formats.
