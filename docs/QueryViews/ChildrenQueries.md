...
Values from the parent QueryView can be used as inputs in the child QueryView. This can be used so the QueryView can access information from another table using a value/id from the Parent QueryView.  
