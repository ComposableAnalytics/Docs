...
- You can navigate within Composable using a period for the home page `.`
    - _Example:_ `./Designer.aspx?appId={{Id}}` links to the DataFlow Designer page for the appID `Id`. This is another way to connect features or monitor apps in Composable.
