...
Composable QueryViews provides a modern web-based approach for running interactive, distributed SQL queries. Simply use a Composable Key to connect to a SQL data source, and query the data where it lives. This includes relational databases or non-traditional data stores such as Hive!
