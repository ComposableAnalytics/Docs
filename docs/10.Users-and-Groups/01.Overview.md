...
Users create accounts in a similar fashion to any other website. The typical [registration workflow](../02.Composable-Platform/02.Navigation.md) steps include:

![Composable Registration](../02.Composable-Platform/img/02.02.Composable2.0_Reg.png)
