...
This is a comprehensive list of columns that may appear in a Container sheet. Fields with an (*) are required to process a sheet.
...
- Page: Link to a single child Container types. Not an input type.
...
- [NumberFormatting](04.Number-Formatting.md): Inputted numbers are displayed in their formatted version. Subject to Locale and Options.
