...
The **\<ColumnName>** column on a container field defines...

{Include sections as appropriate describing possible values, interesting behaviors, and interactions with other column values}

## Controls

The **\<ColumnName>** column applies to the following controls:
